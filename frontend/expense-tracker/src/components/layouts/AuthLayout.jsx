...
const AuthLayout = ({children}) => {
  return (
    <div className='flex'>
      ...
      <div className='hidden md:block w-[40vw] bg-violet-50 bg-cover bg-no-repeat bg-center overflow-hidden p-8 relative'>
        ...
        <img className='w-64 lg:w-[90%] absolute bottom-10 shadow-lg shadow-blue-400/15' src={CARD_2} alt="" />
      </div>
